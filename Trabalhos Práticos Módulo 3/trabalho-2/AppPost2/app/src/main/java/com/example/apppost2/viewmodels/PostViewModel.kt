package com.example.apppost2.viewmodels;
...
import com.example.apppost2.postapp.data.RetrofitInstance
...
class PostViewModel: ViewModel() {
    ...
    fun createPost(title: String, content: String, onSucess: () -> Unit, onError: () -> Unit) {
        viewModelScope.launch {
            try {
